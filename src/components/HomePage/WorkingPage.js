                        ...
                        <TableBody>
                            {this.state.projects.map((project)=>(
                                <TableRow key={project.id}>
                                    ...
                                    <TableCell align="center">{project.numberOfSamples}</TableCell>
                                    <TableCell align="center">{project.status}</TableCell>
                                    <TableCell align="center">{new Date(project.createdAt).toLocaleString('en-US', { timeZone: 'America/New_York' })}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
